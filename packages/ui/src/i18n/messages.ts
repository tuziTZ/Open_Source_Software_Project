...
const en: Messages = {
  ...
  deleteProviderConfig: "Delete Provider",
  clearStoredApiKey: "Clear stored API key",
  configuredProviders: "{count} configured",
...
const zhHans: Messages = {
  ...
  providerName: "提供商名称",
  providerKind: "提供商类型",
  providerDefault: "默认提供商",
  apiKey: "API Key",
  apiKeyHeader: "API Key 请求头",
  saveProvider: "保存提供商",
  deleteProviderConfig: "删除提供商",
  clearStoredApiKey: "清除已保存的 API Key",
  configuredProviders: "已配置 {count} 个",
  noProvidersConfigured: "还没有配置任何提供商。",
  storedSecret: "已保存",
